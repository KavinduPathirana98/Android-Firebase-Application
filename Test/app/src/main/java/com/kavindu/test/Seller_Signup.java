...
public class Seller_Signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller__signup);
        ...
        btn_regtologin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public boolean valiate() {
        ...
        if (name.isEmpty()) {
            ...
            DatabaseReference reference1 = FirebaseDatabase.getInstance().getReference().child("sellers").child(username);
